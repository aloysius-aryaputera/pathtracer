...
Scene* create_scene_2() {
  ...
  additional_geom_array = create_rectangle(
    glm::vec3(0, 15, 0), glm::vec3(0, 15, 30), glm::vec3(-10, -9, 30),
    glm::vec3(-10, -9, 0), glm::vec3(0, 0, 0), glm::vec3(1, 0, 0),
  ...
  //   glm::vec4(0.1, 0.1, 0.1, 1), glm::vec4(1, 1, 1, 1),
  //   glm::vec4(0, 0, 0, 1), glm::vec4(0, 0, 0, 1),
  //   glm::vec4(.5, .5, .5, 1), 50, blue_wood_texture, 3, 3
  // );
  material = new Material(
    glm::vec4(0.1, 0.1, 0.1, 1),
    glm::vec4(0, 0, 0, 1),
...
Scene* create_scene_3() {
  ...
  trans_matrix = translate(0, 0, 8.5) * scale(1.5, 1.5, 1);
  geom_array.push_back(new Sphere());
  parameter_array = prepare_sphere_parameters(
      glm::vec3(0, 0, 0), 2.0, material, trans_matrix
    );
  ...
  material = new Material(
    glm::vec4(0.1, 0.1, 0.1, 1), glm::vec4(1.0, 1.0, 0.0, 1),
    glm::vec4(0, 0, 0, 1), glm::vec4(0, 0, 0, 1),
    glm::vec4(0.5, 0.5, 0.20, 1), 50, plain_texture
  );
  ...
  material = new Material(
    glm::vec4(0.1, 0.1, 0.1, 1), glm::vec4(0, 0, 1, 1),
    glm::vec4(0, 0, 0, 1), glm::vec4(0, 0, 0, 1),
    glm::vec4(0.20, 0.20, 0.5, 1), 50, plain_texture
  );
  ...
  material = new Material(
    glm::vec4(0.1, 0.1, 0.1, 1), glm::vec4(1, 1, 0, 1),
    glm::vec4(0, 0, 0, 1), glm::vec4(0, 0, 0, 1),
    glm::vec4(0.5, 0.20, 0.5, 1), 50, plain_texture
  );
  ...
  material = new Material(
    glm::vec4(0.1, 0.1, 0.1, 1), glm::vec4(1, 0, 0, 1),
    glm::vec4(0, 0, 0, 0), glm::vec4(0, 0, 0, 1),
    glm::vec4(0.5, 0.2, 0.2, 0), 50, plain_texture
  );
  ...
  material = new Material(
    glm::vec4(0.1, 0.1, 0.1, 1), glm::vec4(1, 1, 1, 1),
    glm::vec4(0, 0, 0, 1), glm::vec4(0, 0, 0, 1),
    glm::vec4(0.5, 0.5, 0.5, 1), 50, plain_texture
  );
  additional_geom_array = create_rectangle(
  ...
  material = new Material(
    glm::vec4(0.1, 0.1, 0.1, 1), glm::vec4(0, 1, 0, 1),
    glm::vec4(0, 0, 0, 1), glm::vec4(0, 0, 0, 1),
    glm::vec4(0.2, 0.5, 0.2, 1), 50, plain_texture
  );
  additional_geom_array = create_rectangle(
  ...
  material = new Material(
    glm::vec4(0.1, 0.1, 0.1, 1), glm::vec4(1, 0, 0, 1),
    glm::vec4(0, 0, 0, 1), glm::vec4(0, 0, 0, 1),
    glm::vec4(0.5, 0.2, 0.2, 1), 50, plain_texture
  );
  additional_geom_array = create_rectangle(
